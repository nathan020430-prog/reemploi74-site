...
const META = {
  ...
  'que-faire-de-vos-vieux-ordinateurs': { desc: 'Vieux ordinateur au placard ? Réemploi, pièces ou recyclage : comment choisir, où le déposer en Savoie et Haute-Savoie, ce qu\'il ne faut pas faire, et quoi faire de vos données avant.', priority: '0.7' },
  'donner-un-ordinateur-a-une-association': { desc: 'Donner un ordinateur à une association, une école ou une famille en Savoie et Haute-Savoie : ce dont les structures ont besoin, donner directement ou via Réemploi 74, attestation de cession, reçu fiscal.', priority: '0.7' },
  'effacer-ses-donnees-avant-de-vendre-ou-donner': { desc: 'Sauvegarder, déconnecter ses comptes, lever les verrous, effacer selon le type de disque (HDD, SSD, chiffré, téléphone) : la marche à suivre avant de vendre ou donner un ordinateur, et ce que fait Réemploi 74.', priority: '0.7' },
